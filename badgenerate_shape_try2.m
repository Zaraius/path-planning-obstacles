...
param_struct.obs_y = [0.01]; %[3 1];
param_struct.obs_r = [5]; %[1 2]; 

%%%% Gradient descent parameters %%%%
param_struct.beta = 0.005; %Original: 0.005 %WHAT DOES THIS DO?
param_struct.gamma = 0.95; %Original: 0.9 %WHAT DOES THIS DO? 
param_struct.max_iter = 500;
param_struct.min_gradient = 1e-7;

param_struct.cost_coeff = 15;
param_struct.length_multiplier = 100;
